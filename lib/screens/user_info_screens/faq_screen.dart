      ...
      body: ListView(
        ...
        children: const [
          ...
          FAQItem(
              ...
              answer: '홈 화면에서 날씨 정보 버튼을 클릭하면 구미 거의동의 날씨 정보를 확인할 수 있습니다. 이 정보는 이동수단 선택에 도움을 줍니다.'
          ),
          FAQItem(
              question: '자전거 경로는 어떻게 확인할 수 있나요?',
              answer: '자전거 경로 화면에서는 현재 위치에서 목적지까지의 최적 경로를 제공합니다.'
          ),
          FAQItem(
              question: '택시 인원 모집 게시글은 어떻게 작성하나요?',
              answer: '택시 인원 모집 화면에서 새 게시글을 작성할 수 있습니다. 출발 위치, 목적지, 출발 시간 등의 정보를 작성하면 됩니다..'
          ),
        ],
      ),
    );
